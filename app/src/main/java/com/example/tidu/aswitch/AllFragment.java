...
public class AllFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        arrayList.add(new POJO(R.drawable.grubhubblack,R.drawable.path,"19.00"));
        arrayList.add(new POJO(R.drawable.luftblack,R.drawable.pathgreen,"22.00"));
        arrayList.add(new POJO(R.drawable.uberblack,R.drawable.pathgreen,"16.00"));
        arrayList.add(new POJO(R.drawable.taskrabbitblack,R.drawable.pathgreen,"14.00"));
